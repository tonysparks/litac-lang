...
<a id="func-typespeckindasstr"></a>

### func TypeSpecKindAsStr(enumType: [TypeSpecKind](ast.md#enum-typespeckind)) : \*const char

*public* | *src/ast.lita:1*

---

<a id="func-stmtkindasstr"></a>

### func StmtKindAsStr(enumType: [StmtKind](ast.md#enum-stmtkind)) : \*const char
