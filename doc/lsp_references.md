...
### func (this: \*[ReferenceDatabase](lsp_references.md#struct-referencedatabase)) getTypeReferences(typeid: [Typeid](types.md#typedef-typeid), results: \*Array\<[SrcPos](lex.md#struct-srcpos)\>) : void
...
### func (this: \*[ReferenceDatabase](lsp_references.md#struct-referencedatabase)) getFieldReferences(typeid: [Typeid](types.md#typedef-typeid), offset: i32, results: \*Array\<[SrcPos](lex.md#struct-srcpos)\>) : void
...
|-------|------|-------------|
| `type` | [Typeid](types.md#typedef-typeid) |  |
